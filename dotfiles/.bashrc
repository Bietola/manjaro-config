...
# Programs installed with **cargo**
PATH="~/.cargo/bin:$PATH"

# Programs installed with **bob** (basically just nvim).
...
# Completions from home directory
...
# Defers real conda init until first `conda` invocation to keep shell startup fast.
conda() {
    unset -f conda
